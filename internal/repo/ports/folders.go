...
type FoldersRepository interface {
	...
	GetByIdentity(ctx context.Context, projectID *uuid.UUID, entityType entities.FolderEntityType, identity string) (*entities.Folder, error)
	GetByIdentityIncludingDeleted(ctx context.Context, projectID *uuid.UUID, entityType entities.FolderEntityType, identity string) (*entities.Folder, error)
	List(ctx context.Context, projectID *uuid.UUID, entityType entities.FolderEntityType) ([]*entities.Folder, error)
