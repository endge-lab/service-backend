// Package middleware implements and registers the service HTTP middleware chain.
package middleware
...
func Register(app *fiber.App, cfg *config.Config, meter metric.Meter, logger *zap.Logger) {
	app.Use(fibercors.New(fibercors.Config{
		...
		AllowHeaders:     "Origin, Content-Type, Accept, Authorization, If-Match, If-None-Match, X-Requested-With, X-Endge-Workspace, traceparent, tracestate, baggage",
		ExposeHeaders:    "ETag",
