...
// @Description Возвращает список композиций текущего рабочего пространства с фильтрацией и пагинацией.
// @ID listCompositions
// @Tags Композиции
// @Produce json
...
// @Success 200 {object} ListResponse "Список композиций"
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/compositions/{identity} [get]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/compositions/{identity} [patch]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/compositions/{identity} [delete]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/compositions/{identity}/restore [post]
