...
type CreateRequest struct {
	...
	Source        string `json:"source" validate:"required,max=8388608" example:"defineSimulation({ target: composition(''), overrides: { runtimes: {} } })"`
	SourceVersion int    `json:"sourceVersion" validate:"required,eq=1" example:"1"`
}

type PatchRequest struct {
	shared.PatchDocumentRequest
	Source        *string `json:"source,omitempty" validate:"omitempty,max=8388608" example:"defineSimulation({ target: composition(''), overrides: { runtimes: {} } })"`
	SourceVersion *int    `json:"sourceVersion,omitempty" validate:"omitempty,eq=1" example:"1"`
}

type Response struct {
	shared.DocumentMetadata
	Source        string `json:"source" example:"defineSimulation({ target: composition(''), overrides: { runtimes: {} } })"`
