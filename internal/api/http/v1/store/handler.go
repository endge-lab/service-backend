...
// @Description Возвращает список хранилищ текущего рабочего пространства с фильтрацией и пагинацией.
// @ID listStores
// @Tags Хранилища
// @Produce json
...
// @Success 200 {object} ListResponse "Список хранилищ"
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/stores/{identity} [get]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/stores/{identity} [patch]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/stores/{identity} [delete]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/stores/{identity}/restore [post]
