...
// @Description Возвращает список вычислений текущего рабочего пространства с фильтрацией и пагинацией.
// @ID listComputations
// @Tags Вычисления
// @Produce json
...
// @Success 200 {object} ListResponse "Список вычислений"
...
// @Security BearerAuth
// @Router /api/v1/computations [get]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/computations [post]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/computations/{identity} [get]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/computations/{identity} [patch]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/computations/{identity} [delete]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/computations/{identity}/restore [post]
