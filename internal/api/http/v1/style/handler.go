...
// @Description Возвращает список стилей текущего рабочего пространства с фильтрацией и пагинацией.
// @ID listStyles
// @Tags Стили
// @Produce json
...
// @Success 200 {object} ListResponse "Список стилей"
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/styles/{identity} [get]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/styles/{identity} [patch]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/styles/{identity} [delete]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/styles/{identity}/restore [post]
