...
// @Description Возвращает список типов текущего рабочего пространства с фильтрацией и пагинацией.
// @ID listTypes
// @Tags Типы
// @Produce json
...
// @Success 200 {object} ListResponse "Список типов"
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/types/{identity} [get]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/types/{identity} [patch]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/types/{identity} [delete]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/types/{identity}/restore [post]
