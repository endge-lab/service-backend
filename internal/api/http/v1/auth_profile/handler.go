...
// @Description Возвращает список профилей аутентификации текущего рабочего пространства с фильтрацией и пагинацией.
// @ID listAuthProfiles
// @Tags Профили аутентификации
// @Produce json
...
// @Success 200 {object} ListResponse "Список профилей аутентификации"
...
// @Security BearerAuth
// @Router /api/v1/auth-profiles [get]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/auth-profiles [post]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/auth-profiles/{identity} [get]
...
// @Description Частично изменяет профиль аутентификации; актуальная revision передаётся в If-Match.
// @ID patchAuthProfile
// @Tags Профили аутентификации
// @Accept json
// @Produce json
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/auth-profiles/{identity} [patch]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/auth-profiles/{identity} [delete]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/auth-profiles/{identity}/restore [post]
