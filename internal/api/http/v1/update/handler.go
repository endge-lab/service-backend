...
// @Description Возвращает список обновлений состояния текущего рабочего пространства с фильтрацией и пагинацией.
// @ID listUpdates
// @Tags Обновления состояния
// @Produce json
...
// @Success 200 {object} ListResponse "Список обновлений состояния"
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/updates/{identity} [get]
...
// @Description Частично изменяет обновление состояния; актуальная revision передаётся в If-Match.
// @ID patchUpdate
// @Tags Обновления состояния
// @Accept json
// @Produce json
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/updates/{identity} [patch]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/updates/{identity} [delete]
...
// @Failure 500 {object} shared.ErrorResponse "Внутренняя ошибка сервера"
// @Security BearerAuth
// @Router /api/v1/updates/{identity}/restore [post]
