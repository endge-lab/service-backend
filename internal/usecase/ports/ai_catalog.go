...
type AICatalogRepository interface {
	ListAIProviderConnections(context.Context, string) ([]entities.AIProviderConnection, error)
	GetAIProviderConnection(context.Context, string, string) (*AIProviderConnectionRecord, error)
	...
	ListAIModelProfiles(context.Context, bool, string) ([]entities.AIModelProfile, error)
	GetAIModelProfile(context.Context, string, string) (*entities.AIModelProfile, error)
