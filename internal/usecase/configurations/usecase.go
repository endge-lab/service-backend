...
var Definition = documents.Definition{Collection: "configurations"}

type UseCase struct {
	lifecycle  *documents.Lifecycle
	repository ports.ConfigurationRepository
}

func NewUseCase(lifecycle *documents.Lifecycle, repository ports.ConfigurationRepository) *UseCase {
