...
var Definition = documents.Definition{Collection: "navigations"}

// UseCase координирует сценарии работы с навигациями.
type UseCase struct {
	lifecycle  *documents.Lifecycle
	repository ports.NavigationRepository
}

// NewUseCase создаёт use case для работы с навигациями.
func NewUseCase(lifecycle *documents.Lifecycle, repository ports.NavigationRepository) *UseCase {
	return &UseCase{lifecycle: lifecycle, repository: repository}
}

// List возвращает документы ресурса «Навигации» с учётом фильтров.
...
// Get возвращает документ ресурса «Навигации» по identity.
...
// Create создаёт документ ресурса «Навигации» и фиксирует новую ревизию.
...
// Patch частично обновляет документ ресурса «Навигации» с проверкой ожидаемой ревизии.
...
// Delete мягко удаляет документ ресурса «Навигации» с проверкой ожидаемой ревизии.
...
// Restore восстанавливает мягко удалённый документ ресурса «Навигации».
