...
func (x *ProviderAccess) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProviderAccess) GetBaseUrl() string {
	if x != nil {
		return x.BaseUrl
	}
	return ""
...
func (x *ProviderAccess) GetCredential() string {
	if x != nil {
		return x.Credential
	}
	return ""
...
func (x *RunRequest) GetProviderAccess() *ProviderAccess {
	if x != nil {
		return x.ProviderAccess
	}
	return nil
}
