...
Пошаговая проверка release cache через Scalar, без ручной передачи полного
snapshot между запросами, описана в
[`docs/Ручная проверка release cache.md`](docs/%D0%A0%D1%83%D1%87%D0%BD%D0%B0%D1%8F%20%D0%BF%D1%80%D0%BE%D0%B2%D0%B5%D1%80%D0%BA%D0%B0%20release%20cache.md).
