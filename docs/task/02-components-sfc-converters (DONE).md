...
```text
GET    /api/v1/projects/:project_identity/components-legacy?folder_identity=...&component_type=component-sfc
POST   /api/v1/projects/:project_identity/components-legacy
GET    /api/v1/projects/:project_identity/components-legacy/:component_identity
PATCH  /api/v1/projects/:project_identity/components-legacy/:component_identity
DELETE /api/v1/projects/:project_identity/components-legacy/:component_identity
POST   /api/v1/projects/:project_identity/components-legacy/:component_identity/restore
DELETE /api/v1/projects/:project_identity/components-legacy/:component_identity/hard
```
...
- `DELETE /api/v1/projects/:project_identity/components-legacy/:component_identity` делает soft-delete.
