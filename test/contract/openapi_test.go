...
func TestDocumentOpenAPIConcurrencyContract(t *testing.T) {
	document := readOpenAPI(t)
	collections := []string{"folders", "types", "queries", "data-views", "compositions", "stores", "streams", "updates", "mocks", "components", "actions", "filters", "converters", "computations", "vocabs", "i18n-bundles", "auth-profiles", "navigations", "styles", "configurations"}
